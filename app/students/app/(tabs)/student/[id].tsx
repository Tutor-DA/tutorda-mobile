...
const mockStudentData = {
  ...
  averageScore: 87,
  recentQuizzes: [
    { id: '1', name: 'Calculus Midterm', date: '2024-01-15', score: 92, passed: true },
    { id: '2', name: 'Physics Lab Report', date: '2024-01-12', score: 88, passed: true },
    { id: '3', name: 'Chemistry Quiz 3', date: '2024-01-10', score: 76, passed: true },
    { id: '4', name: 'History Essay', date: '2024-01-08', score: 94, passed: true },
    { id: '5', name: 'Programming Assignment', date: '2024-01-05', score: 89, passed: true }
  ],
};
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileSection}>
          ...
          <TouchableOpacity style={styles.messageButton} onPress={handleMessagePress} activeOpacity={0.8}>
          ...
          {mockStudentData.recentQuizzes.map((quiz) => (
            <View key={quiz.id} style={styles.activityCard}>
              ...
              <View style={styles.scoreContainer}>
                <Text style={[styles.scoreText, { color: quiz.passed ? '#10B981' : '#EF4444' }]}>
                  {quiz.score}%
                </Text>
                <Text style={[styles.statusText, { color: quiz.passed ? '#10B981' : '#EF4444' }]}>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingVertical: 16, backgroundColor: '#FFFFFF', borderBottomWidth: 1,
  ...
  studentName: { fontSize: 24, fontWeight: '700', color: '#1F2937', marginBottom: 4 },
  studentEmail: { fontSize: 16, color: '#6B7280', marginBottom: 24 },
  messageButton: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: '#6366F1', paddingHorizontal: 24,
    paddingVertical: 12, borderRadius: 24,
  },
  messageButtonText: { color: '#FFFFFF', fontSize: 16, fontWeight: '600', marginLeft: 8 },
  statsGrid: { flexDirection: 'row', flexWrap: 'wrap', paddingHorizontal: 24, paddingVertical: 24, gap: 16 },
  statCard: {
  ...
  statLabel: { fontSize: 12, color: '#6B7280', textAlign: 'center', fontWeight: '500' },
  ...
  scoreText: { fontSize: 18, fontWeight: '700', marginBottom: 2 },
